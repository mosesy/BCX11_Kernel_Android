...
#endif
	{ RT5645_HP_VOL		, 0x0707 },/* OUTMIX -> HPVOL */
#if 0 /* SPK direct path */
	{ RT5645_SPO_MIXER	, 0x7803 },/* DAC1 -> SPO */
#else /* SPK via mixer path */
	{ RT5645_SPK_L_MIXER	, 0x0034 },/* DAC1 -> SPKVOL */
	{ RT5645_SPK_R_MIXER	, 0x0034 },/* DAC1 -> SPKVOL */
	{ RT5645_SPO_MIXER	, 0xd806 },/* SPKVOL -> SPO */
#endif
	{ RT5645_SPK_VOL	, 0x0909 },
	/* record */
	{ RT5645_IN1_IN2	, 0x0040 },/* IN2 differential mode */
	{ RT5645_REC_L2_MIXER	, 0x005f },/* INL -> RECMIXL */
	{ RT5645_REC_R2_MIXER	, 0x005f },/* INR -> RECMIXR */
	{ RT5645_INL1_INR1_VOL	, 0x0b0b },/* Line In vol -4.5dB */
#if 0 /* DMIC1 */
...
#endif
	{ RT5645_AD_DA_MIXER	, 0x0000 }, /* STO ADC -> STO DAC */
...
int rt5645_check_jd_status(struct snd_soc_codec *codec)
{
	...
	ret = snd_soc_read(codec, RT5645_A_JD_CTRL1) & 0x0020;
	pr_debug("%s: ret = %d\n", __func__, ret);
