...
static struct gpio_keys_button gpio_button[] = {
	...
	{KEY_BRIGHTNESSUP,		-1, 1, "bright_up",		EV_KEY, 0, 20},
	{KEY_BRIGHTNESSDOWN,	-1, 1, "bright_down",	EV_KEY, 0, 20},
...
static struct gpio_keys_button lesskey_button_rolock[] = {
	{KEY_RO,		-1, 1, "rotationlock",	EV_KEY, .acpi_idx = 3},
	{ },
};
...
static struct gpio_keys_button lesskey_button_bright[] = {
	{KEY_BRIGHTNESSUP,		-1, 1, "bright_up",	EV_KEY, .acpi_idx = 4},
	{KEY_BRIGHTNESSDOWN,	-1, 1, "bright_down",	EV_KEY, .acpi_idx = 5},
};
...
static struct gpio_keys_init_data lesskey_init_data[KEY_TYPE_NUMS] = {
	{
		...
		.keys_button = lesskey_button_bright,
		.nkeys = sizeof(lesskey_button_bright) /
			 sizeof(struct gpio_keys_button),
	},
};
...
static struct platform_device lesskey_device[KEY_TYPE_NUMS] = {
	{
		...
		.id		= PLATFORM_DEVID_AUTO,
		.dev		= {
			.platform_data	= &lesskey_keys[BRIGHT_KEYS],
		},
	},
};
